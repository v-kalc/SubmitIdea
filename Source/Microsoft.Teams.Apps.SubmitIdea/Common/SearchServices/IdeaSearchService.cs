...
namespace Microsoft.Teams.Apps.SubmitIdea.Common.SearchServices
{
    ...
    public class IdeaSearchService : IIdeaSearchService, IDisposable
    {
            ...
            string filterQuery = null)
        {
            ...
            {
                searchQuery = this.EscapeCharactersInQuery(searchQuery);
            }
        ...
        private async Task InitializeAsync()
        {
            try
            {
                // When there is no team post created by user and Messaging Extension is open, storage data source initialization is required here before creating search index or data source or indexer.
